...
- `D:\Google Antigravity\AS_AI導入支援事業_cc\` が作業ディレクトリ
...
cd "D:\Google Antigravity\AS_AI導入支援事業_cc"
...
Copy-Item "D:\Google Antigravity\AS_AI導入支援事業_cc\05_クライアント案件\YYYYMMDD_クライアント名\AI導入支援_完全提案パッケージ_クライアント名_v2.html" `
...
# 3. 公開リポジトリを更新
Copy-Item "D:\Google Antigravity\AS_AI導入支援事業_cc\05_クライアント案件\...\AI導入支援_完全提案パッケージ_クライアント名_v2.html" `
