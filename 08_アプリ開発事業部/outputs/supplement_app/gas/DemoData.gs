...
function _insertWeeklyReports(ss, userId) {
  ...
  var REPORTS = [
    ...
    {week:'2026-03-14',text:'5週目。体重はわずかに停滞気味ですが、これはよくある2〜3週間サイクルの調整期です。体調スコアが改善しているのは良いシグナル。停滞期こそ記録が重要です！',stats:{weight_change:-0.1,taken_rate:88,avg_mood:3}},
    ...
    {week:'2026-03-28',text:'7週目。今週は少し疲れが出た日もありましたが、服用率を維持できています。体重59.7kgで着実に前進中。バイオサイクルの体力が充実期に入っているので、この調子です！',stats:{weight_change:-0.2,taken_rate:86,avg_mood:3}},
    ...
    {week:'2026-04-25',text:'11週目。体重58.5kgまで到達。3か月継続の目標まであと2週間！服用率・記録率ともに高水準をキープ。カラダのリズムが完全に整ってきた証拠です。',stats:{weight_change:-0.3,taken_rate:86,avg_mood:4}},
